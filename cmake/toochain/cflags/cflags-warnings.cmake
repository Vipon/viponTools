...
set(WARNING_FLAGS)
append_cflagc(WARNING_FLAGS "-Wall -Wextra -Wcast-qual -Wnewline-eof -Wparentheses -Wsign-conversion -fdiagnostics-color=always")

if("${CMAKE_C_COMPILER_ID}" STREQUAL "GNU")
  # clang doesn't support these flags (this causes too many warnings)
  append_cflagc(WARNING_FLAGS "-Wduplicated-branches -Wduplicated-cond")
endif()
...
set(WARNING_CFLAGS)
append_cflagc(WARNING_CFLAGS "-Wmissing-prototypes -Wstrict-prototypes")
